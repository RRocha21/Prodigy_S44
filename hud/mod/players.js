...
exports.updatePlayer = (req, res) => {
    ...
    function removeAvatarFile(err, playerList) {
        ...
        if (user.avatar == undefined) {
            user.avatar = playerList[0].avatar;
        } else {
            if (fs.existsSync('./IngamePic/' + playerList[0].avatar)) fs.unlinkSync('./IngamePic/' + playerList[0].avatar);
        }
    ...
    db.find({_id: userId}, removeAvatarFile);
};
...
exports.deleteAvatar = (req, res) => {
    ...
    function removeAvatarFile(err, playerList) {
        ...
        if (fs.existsSync('./public/players/' + playerList[0].avatar)) fs.unlinkSync('./public/players/' + playerList[0].avatar);
