...
var t_color = "230, 61, 30";
var ct_color = "45, 155, 245";
...
// var count = 1;
// numtext = 0;
// var txt = "../../files/img/hud_elements/logo.png";
// var txt_sponsor = "../../files/img/hud_elements/SLIDE_2.png";
// var count = 1;
// $(".topbar_container>.topbar_i_logo>.inner").html("<img src'" + txt + "' />");
// $(".sponsor>.inner").html("<img src='" + txt_sponsor + "'></img>")
// $(document).ready(
//     function() {
...
//             //     $(this).html("<img src='" + txt + "'></img>")

//             // }).fadeIn();
//             // $(".sponsor>.inner").fadeOut(function() {
//             //     $(this).html("<img src='" + txt_sponsor + "'></img>")
//             // }).fadeIn();
//         }, 15000);
//     });
...
function fillObserved(player) {
    ...
    if (player.team == "CT" && teams.left.side == "ct") {
        ...
        $(".observed_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
        ...
        $(".sponsor").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
        $(".sponsor").css("box-shadow", "inset 0px 0px 10px 3px rgb(" + ct_color + ")");
        ...
        $(".sponsor").css("box-shadow", "inset 0px 0px 10px 3px rgb(" + t_color + ")");
        $(".sponsor").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
    ...
    for (let key in weapons) {
        ...
        if (weapon.state == "active" || weapon.state == "reloading") {
            if (weapon.type == "Grenade" || weapon.type == "C4" || weapon.type == "Knife" || statistics.health == 0) {
                ...
                $(".observed_container>.bullets_icon").css("opacity","0");
            } else {
                if(weapon.ammo_reserve == "undefined" || weapon.ammo_reserve == null){
                    $(".observed_container>.bullets_icon").css("opacity","1");
                    $(".observed_container>.bullets").html("");
                } else {
                    $(".observed_container>.bullets_icon").css("opacity","1");
    ...
    // SET AVATAR
    avatar = loadAvatar(player.steamid);
    $(".picture").html("<img width='130px' height='130px' src='/av/" + avatar + "'/>");
...
function fillPlayers(teams) {
    ...
    if((left_alive != 1) && (right_alive != 1)){
        ...
        $(".topbar_i_counter>.title").css("font-size", "21px");
        $(".topbar_i_counter>.title").css("line-height", "1.5");
        $(".topbar_i_counter>.title").css("background", "rgba(0,0,0,0.7)");
        $(".topbar_i_counter>.title").css("box-shadow", "");
        side = 0;
    }else{  
        if((left_alive == 1) || (side != 2) ){
            if (teams.left.side == "t"){
                $(".topbar_i_counter>.title").css("box-shadow", "inset 0px 0px 25px 5px rgb(" + t_color + ")");
            }
            if (teams.left.side == "ct"){
                $(".topbar_i_counter>.title").css("box-shadow", "inset 0px 0px 25px 5px rgb(" + ct_color + ")");
            }
            side = 1;
        } 
        if ((right_alive == 1) || (side != 1)){
        ...
        $(".topbar_i_counter>.title").css("font-size", "16px");
...
function fillPlayer(player, nr, side, max) {
    ...
    if (side == "right") {
        if (team == "ct") {
            ...
            // $(".bo5_container>.right_series").find(".win").css("box-shadow", "rgba(" + dark_ct_color + ",1) 0px 0px 15px 3px");
            ...
            $(".players_right_container>.player_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".player_count_right").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_right>.team_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".header_container>.right_inner").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_right>.equip_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            ...
            // $(".bo5_container>.right_series").find(".win").css("box-shadow", "rgba(" + dark_t_color + ",1) 0px 0px 15px 3px");
            $(".players_right_container>.player_container").css("background", "linear-gradient(to right, rgba(" + dark_t_color + ",0.8) 100%, transparent 100%)");
            $(".players_right_container>.player_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".player_count_right").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".header_container>.right_inner").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_right>.team_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
    ...
    if (side == "left") {
        if (team == "ct") {
            ...
            // $(".bo5_container>.left_series").find(".win").css("box-shadow", "rgba(" + dark_ct_color + ", 1) 0px 0px 15px 3px");
            $(".players_left_container>.player_container").css("background", "linear-gradient(to right, rgba(" + dark_ct_color + ",0.8) 100%, transparent 100%)");
            $(".players_left_container>.player_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".player_count_left").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".header_container>.left_inner").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_left>.team_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_left>.equip_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            ...
            // $(".bo5_container>.left_series").find(".win").css("box-shadow", "rgba(" + dark_t_color + ",1) 0px 0px 15px 3px");
            ...
            // $(".players_left_container>.player_container").css("background-image", "url(../../files/img/hud_elements/background_t.png)");
            $(".player_count_left").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".header_container>.left_inner").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_left>.team_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
            $(".firepower_money_left>.equip_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
    ...
    if(statistics.health == 0){
        if(player.observer_slot <= 5){
            if (statistics.round_kills > 0) {
                // $player.find(".background>.frags").html(statistics.round_kills);
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(0px)");
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(8px)");
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(4px)");
                $player.find(".Round_kills>.frags").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(3px)");
                // $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
            } else {
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(75px)");
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(75px)");
                $player.find(".Round_kills>.frags").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
            }
            $player.find(".Round_kills>.background").css("clip-path", "polygon(37% 0, 100% 0, 100% 100%, 3% 100%)");
        }else{
            if (statistics.round_kills > 0) {
                // $player.find(".background>.frags").html(statistics.round_kills);
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(0px)");
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(-8px)");
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(-4px)");
                $player.find(".Round_kills>.frags").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(-1px)");
                // $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
            } else {
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(75px)");
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(75px)");
            ...
            $player.find(".Round_kills>.background").css("clip-path", "polygon(0 0, 67% 0, 97% 100%, 0% 100%)");
        }
    } else {
        if(player.observer_slot <= 5){
            $player.find(".Round_kills>.background").css("clip-path", "polygon(50% 0, 100% 0, 100% 100%, 0% 100%)");
            if (statistics.round_kills > 0) {
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(0px)");
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(0px)");
                $player.find(".Round_kills>.frags").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
                // $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
            } else {
            ...
            $player.find(".Round_kills>.background").css("clip-path", "polygon(0 0, 50% 0, 100% 100%, 0% 100%)");
            if (statistics.round_kills > 0) {
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(0px)");
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(0px)");
                $player.find(".Round_kills>.frags").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
                ...
                $player.find(".Round_kills>.background").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(-5px)");
                $player.find(".Round_kills").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateY(75px)");
                $player.find(".Round_kills>.frags").css("transition", "transform 0.5s ease-out 0s").css("transform", "translateX(0px)");
            }
        }
...
function updatePage(data) {
    ...
    if (matchup && matchup.toLowerCase() != "bo1") {
        bo = 3;
        text_for_map = "DECIDER";
    } else {
        bo = 1;
        var map = data.map();
        var map_text = map.name.slice(3);
        map3 = map_text;
        text_for_map = "BEST OF 1";
    }
    if (matchup && matchup.toLowerCase() != "bo1") {
        ...
        $(".bo5_container .left_series").html(left_bl);
        $(".bo5_container .right_series").html(right_bl);

        $(".bo5_container>.bo_type>.bo_text").html("BO3");

        $(".block").css("display", "-webkit-inline-box");
        $("#ticker_text").text("BEST OF " + matchup.substr(2));

    } else {
        $(".bo5_container>.bo_type>.bo_text").html("BEST OF ONE");
    ...
    /* MAP PICKS START  */
    if (swapsides == 0) {
        $(".map_picks>.first_map>.text_container").html("<font color='#fff'>" + team_pick_left_name + "</font>");
        ...
        $(".map_picks>.second_map>.text_container").html("<font color='#fff'> " + team_pick_right_name + " </font>");
        ...
        $(".map_picks>.decider_map>.text_container").html("<font color='#fff'> "+ text_for_map +" </font>");
        ...
        $(".map_picks>.first_map>.text_container").html("<font color='#fff'>" + team_pick_right_name + "</font>");
        ...
        $(".map_picks>.second_map>.text_container").html("<font color='#fff'> " + team_pick_left_name + " </font>");
    ...
    if (match_type == "esea") {
        ...
        for (i = 0; i < total_rounds; i++) {
            if (total_rounds < 15) {
                ...
                $(".round_winner>.rounds_" + nr).css("font-size", "11px");
                $(".round_winner>.rounds_" + nr).css("line-height", "1.1");
                $(".round_winner>.rounds_" + i).css("background-color", "rgba(0,0,0,0)");
                ...
                if (nr < 16) {
                    for (j = 0; j < 16; j++) {
                        ...
                        $(".round_winner>.rounds_" + j).html(" ");
                    }
                }

                $(".round_winner>.rounds_" + z).html(nr);
                $(".round_winner>.rounds_" + z).css("font-size", "11px");
                $(".round_winner>.rounds_" + z).css("line-height", "1.1");
                $(".round_winner>.rounds_" + i).css("background-color", "rgba(0,0,0,0)");

                if (nr > 15) {
                    if (round_wins[z].startsWith('ct_')) {
                        $(".round_winner>.team_right_" + z).css("box-shadow", "inset 0 10px 15px  rgba(" + ct_color + ",0.8)");
                        if (round_wins[z].startsWith('ct_win_elimination')) {
                            ...
                            $(".round_winner>.team_right_" + z + ">.result ").css("background-image", "url(/files/img/hud_elements/defuse.png)");
                        } else if (round_wins[z].startsWith('ct_win_time')) {
                            $(".round_winner>.team_right_" + z + ">.result ").css("background-image", "url(/files/img/hud_elements/ampulheta.png)");
                        }
                    } else {
    ...
    } else if ((match_type == "faceit") || (match_type == "none")) {
        for (i = 0; i < total_rounds; i++) {
            if (total_rounds < 15) {
                nr = i + 1;
                $(".round_winner>.rounds_" + nr).html(nr);
...
// linear-gradient(90deg, rgba(" + dark_ct_color + ",0.85) 0%, rgba(" + dark_t_color + ",0.9) 100%)
    // $(".bo5_container").css("border-radius","5px");
    // $(".bo5_container").css("box-shadow", "inset 0 0 12px 12px white, inset 0 0 3px 2px black");
    ...
    // $(".bo5_container>.left_container").css("border","solid 2px rgb("+ left_color +")");
    // $(".bo5_container>.left_container").css("box-shadow", "inset 0px 0px 10px 2px rgb("+ left_color +")");
    // $(".bo5_container>.right_container").css("box-shadow", "inset 0px 0px 10px 2px rgb("+ right_color +")");
    ...
    $(".header_container>.left_line").css("box-shadow", "inset 0px 0px 20px 3px rgb(" + left_color + ")");

    $(".win_container_left").css("-webkit-mask-image", "linear-gradient(to right, black 85%, transparent 100%)");
    $(".win_container_left").css("border", "solid 5px rgb(" + left_color + ")");
    $(".win_container_left").css("box-shadow", "inset 0px 0px 20px 3px rgb(" + left_color + ")");


    $(".win_container_right").css("-webkit-mask-image", "linear-gradient(to left, black 85%, transparent 100%)");
    $(".win_container_right").css("border", "solid 5px rgb(" + right_color + ")");
    $(".win_container_right").css("box-shadow", "inset 0px 0px 20px 3px rgb(" + right_color + ")");
    ...
    $(".header_container>.right_line").css("box-shadow", "inset 0px 0px 20px 3px rgb(" + right_color + ")");
    ...
    $(".header_container > .left_logo_container").css("border", "solid 4px rgb("+ left_color + ")");
    $(".header_container > .left_logo_container").css("box-shadow", "inset -2px 0px 10px 2px rgb(" + left_color + ")");
    ...
    $(".alerts_container > .left > .background-image").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
    ...
    $(".player_count_left").css("box-shadow", "inset 0px 0px 10px 3px rgb(" + left_color + ")");
    ...
    $(".spam > .left_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
    ...
    //RIGHT
    $(".header_container > .right_logo_container").css("border", "solid 4px rgb("+ right_color + ")");
    $(".header_container > .right_logo_container").css("box-shadow", "inset 2px 0px 10px 2px rgb(" + right_color + ")");
    // $(".header_container > .right_logo_container").css("box-shadow", "3px 0px 11px 4px rgb(" + right_color + ")");
    ...
    $(".player_count_right").css("box-shadow", "inset 0px 0px 10px 3px rgb(" + right_color + ")");


    $(".spam > .right_container").css("background", "linear-gradient(to left, rgba(0,0,0, 0.85) 100%, transparent 100%)");
    ...
    if (teams.left.logo) {
        ...
        $(".left_logo_container > .logo").html(team_left_just_letter);
        // $(".left_logo_container > .logo").css("color", "rgb(" + left_color + ")");
    }
    if (teams.right.logo) {
        ...
        $(".right_logo_container > .logo").html(team_right_just_letter);
        // $(".right_logo_container > .logo").css("color", "rgb(" + right_color + ")");
    }
    ...
    if (phase) {
        ...
        function startAnimationWinner(side, name, gameside) {
            ...
            if (side == "left") {
                $(".win_container_left").css("transform", "translateY(0px)").css("transition", "all 0.6s ease 0.1s");
                $(".win_container_left").css("opacity", "1");
            } else if (side == "right") {
                $(".win_container_right").css("transform", "translateY(0px)").css("transition", "all 0.6s ease 0.1s");
        ...
        function stopAnimationWinner() {
            ...
            $(".win_container_left").css("transform", "translateY(-40px)").css("transition", "all 0.8s ease 1.4s");
            $(".win_container_right").css("transform", "translateY(-40px)").css("transition", "all 0.8s ease 1.4s");
        ...
        if (phase.phase_ends_in) {
            ...
            if (phase.phase == "bomb" && bomb_time > "9" || phase.phase == "defuse") {
                $(".time").html(Math.round(bomb_time, -2));
                $(".time").css("font-size", "45px");
                $(".time").css("top", "12px");


                $(".time").css("animation", "pulseA 40s ease-in-out forwards");
                $(".header_container>.center_inner>.inner_shadow").css("animation", "pulseA 40s ease-in-out forwards");
                $(".header_container>.center_inner>.inner_shadow").css("animation", "pulseA 40s ease-in-out forwards");
                $(".header_container>.center_inner>.center_inner_back").css("animation", "pulseA 40s ease-in-out forwards");
                $(".header_container>.center_inner>.center_inner_back_2").css("animation", "pulseA 40s ease-in-out forwards");

                $(".header_container>.center_inner>.inner_shadow").css("border", "solid 3px rgb(" + warning + ")");
                $(".header_container>.center_inner>.inner_shadow").css("box-shadow", "inset 0px 0px 20px 5px rgb(" + warning + ")");
                $(".center_inner_back").css("border-top", "solid 3px rgb(" + warning + ")");
                $(".header_container>.center_inner>.center_inner_back").css("box-shadow", "inset 0px 0px 70px 0px rgb(" + warning + ")");
                $(".center_inner_back_2").css("border-top", "solid 3px rgb(" + warning + ")");
                $(".header_container>.center_inner>.center_inner_back_2").css("box-shadow", "inset 0px 0px 70px 0px rgb(" + warning + ")");

            } else if (phase.phase == "bomb" && bomb_time <= "9.99999" && bomb_time >= "0") {
                $(".time").html("<font size='10px'>" + Math.round(bomb_time, -2) + "</font>");
                $(".time").css("font-size", "45px");
                $(".time").css("top", "12px");
                $(".header_container>.center_inner>.inner_shadow").css("border", "solid 3px rgb(" + warning + ")");
                $(".header_container>.center_inner>.inner_shadow").css("box-shadow", "inset 0px 0px 50px 5px rgb(" + warning + ")");
                $(".center_inner_back").css("border-top", "solid 3px rgb(" + warning + ")");
                $(".header_container>.center_inner>.center_inner_back").css("box-shadow", "inset 0px 0px 70px 0px rgb(" + warning + ")");
                $(".center_inner_back_2").css("border-top", "solid 3px rgb(" + warning + ")");
                $(".header_container>.center_inner>.center_inner_back_2").css("box-shadow", "inset 0px 0px 70px 0px rgb(" + warning + ")");
                ...
                stopAnimationWinner();
                $(".time").css("font-size", "28px");
                $(".time").css("top", "25px");
                $(".time").css("animation", "");
                $(".header_container>.center_inner>.inner_shadow").css("animation", "");
                $(".header_container>.center_inner>.inner_shadow").css("animation", "");
                $(".header_container>.center_inner>.center_inner_back").css("animation", "");
                $(".header_container>.center_inner>.center_inner_back_2").css("animation", "");
